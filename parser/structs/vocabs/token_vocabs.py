...
class TokenVocab(CountVocab):
        ...
        with tf.variable_scope(variable_scope or self.classname):
            ...
            with tf.variable_scope('Classifier'):
                ...
                with tf.device('/gpu:1'):
                    weights = tf.get_variable('Weights', shape=[len(self), input_size],
                    ...
                    cand_weights = tf.stop_gradient(
                        tf.concat([nn.ones([batch_size * bucket_size, 1]), sample_weights], axis=-1))
    ...
    # =============================================================
    def get_bilinear_classifier_with_embeddings(self, layer, embeddings, token_weights, variable_scope=None,
                                                reuse=False):
        """"""
    ...
    # =============================================================
    def get_unfactored_bilinear_classifier(self, layer, unlabeled_targets, token_weights, variable_scope=None,
                                           reuse=False):
        """"""
